...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    NamedCommands.registerCommand("Feeder", m_coralSubSystem.feeder(Setpoint.kFeederStation));
    NamedCommands.registerCommand("L4", m_coralSubSystem.feeder(Setpoint.kLevel4));
